...
footer = dbc.Container(
    dbc.Row(
        dbc.Col(
            html.P(
                [
                    html.Span('Brian Ross', className='mr-2'), 
                    html.A(html.I(className='fas fa-envelope-square mr-1'),  href='mailto:brian@brianthomasross.com'), 
                    html.A(html.I(className='fab fa-github-square mr-1'), href='https://github.com/brianthomasross/'), 
